# Contributing to LlamaGpt

Thank you for your interest in contributing to LlamaGpt! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaGpt:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamagpt.git
   cd llamagpt
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamagpt.git
   ```
...
By contributing to LlamaGpt, you agree that your contributions will be licensed under the project's MIT License.
